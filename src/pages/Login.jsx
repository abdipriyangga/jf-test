    ...
    <main>
      <div className="flex flex-row">
        ...
        <div>
          ...
          <div>
            <p className="text-black font-bold text-xl text-center">Login</p>
          </div>
          <div className="p-12 mx-8">
            <form onSubmit={onLogin} className="space-y-8">
              ...
              <div>
                <button className="focus:outline-none text-white font-bold text-lg bg-indigo-300 py-4 rounded-lg w-full" type="submit">Login</button>
              </div>
            </form>
          </div>
        </div>
